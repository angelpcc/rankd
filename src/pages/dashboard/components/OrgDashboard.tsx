          ...
          {activeTab === 'overview' && (
            <div className="space-y-6 max-w-4xl">
              ...
              <div className="rk-card relative overflow-hidden anim-fade-up" style={{ padding: 0, transform: 'none' }}>
                ...
                <img src="/images/evento.webp" alt="" aria-hidden="true" className="absolute inset-0 w-full h-full object-cover pointer-events-none" style={{ opacity: 0.14, objectPosition: 'center 45%' }} />
