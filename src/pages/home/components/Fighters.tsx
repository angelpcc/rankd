...
export default function Fighters() {
  ...
  return (
    <section id="fighters" style={{ padding: '80px 0', background: '#070707', position: 'relative', overflow: 'hidden' }}>
      {/* BG sutil */}
      <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
        <img src="https://images.unsplash.com/photo-1471295253337-3ceaaedca402?w=1920&q=80&fit=crop" alt="" style={{ width: '100%', height: '100%', objectFit: 'cover', opacity: 0.06 }} />
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1280, margin: '0 auto', padding: '0 20px' }}>
        {/* Header */}
        <div className="fighters-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 40, flexWrap: 'wrap', gap: 20 }}>
          <div>
      ...
      <style>{`
        @media(max-width:860px){
          .fighters-grid { grid-template-columns: 1fr 1fr !important; gap: 12px !important; }
          .fighters-header { flex-direction: column !important; align-items: flex-start !important; }
          .fighters-filters { width: 100% !important; justify-content: flex-start !important; }
        }
        @media(max-width:520px){
          .fighters-grid { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </section>
  );
