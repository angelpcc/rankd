...
Remo con barra 4x10`,
  ...
  mc_pt_free: 'Libre',
  mc_pt_free_hint: 'Va a tu ritmo: cuando termines, pulsa «Hecho».',
  mc_pt_rv_details: 'Detalles (opcional)',
  mc_pt_rv_minutes: 'Minutos',
  mc_pt_rv_note: 'Notas',
  mc_pt_rv_note_ph: 'Cómo ha ido, qué cambiarías…',
  mc_pt_rv_need_min: 'Pon los minutos que has hecho para guardarlo.',
  mc_pt_rv_back: 'Volver a la sesión',
  mc_ag_go_title: '¿Cómo lo haces?',
  mc_ag_go_start: 'Empezar ahora',
  mc_ag_go_start_hint: 'Con cronómetro y la nota del plan a la vista. Al acabar lo guardas con tu ritmo, distancia o notas.',
  mc_ag_go_start_plain: 'Empezar sin asaltos, solo con cronómetro',
  mc_cs_to_timer: 'Ir al temporizador',
  mc_cs_do_table: 'Seguir la tabla',
  mc_cs_saved_boxing: 'Guardada en Asesor › Sesión',
