...
export default {
  ...
  mc_pt_empty_desc: 'Pega en Agenda › Planificar la tabla que te haya pasado tu entrenador y la convertimos en un guion que puedes seguir mientras entrenas. O crea uno a mano, tramo a tramo.',
  mc_pt_play: 'Empezar',
  ...
  mc_pt_done_title: '¡Sesión terminada!',
...
10-15 incl 3   vel 6,5`,
  ...
  mc_rp_empty_desc: 'Pega en Agenda › Planificar la rutina que ya tengas escrita y la convertimos en un checklist que puedes ir marcando. O créala a mano, con tus días y ejercicios.',
...
Remo con barra 4x10`,
  ...
  mc_pt_prev: 'Anterior',
  mc_pt_of_total: 'de {{time}}',
  mc_pt_elapsed: 'Llevas {{time}}',
  mc_pt_reps: 'reps',
  mc_pt_reps_manual: 'Haz las repeticiones a tu ritmo y pulsa «Hecho» al terminar.',
  mc_pt_rest_title: 'Respira',
  mc_pt_rest_eyebrow: 'Descanso',
  mc_pt_get_ready: 'Prepárate',
  mc_pt_whole: 'La sesión entera',
  mc_pt_tap_to_jump: 'Toca un tramo para ir a él',
  mc_pt_col_time: 'Tiempo',
  mc_pt_keys_hint: 'Espacio: pausa · ← →: cambiar de tramo',
  mc_cs_default_name: 'Sesión del Asesor',
  mc_cs_rest: 'Descanso',
  mc_cs_segments_one: '{{count}} tramo',
  mc_cs_segments_other: '{{count}} tramos',
  mc_cs_do: 'Hacer esta sesión',
  mc_cs_save: 'Guardar',
  mc_cs_saved: 'Guardada',
  mc_cs_saved_toast: 'Guardada en Actividad › Cardios guardados',
  mc_cs_saved_local: 'Guardada en este dispositivo: la tienes en Actividad › Cardios guardados',
};
