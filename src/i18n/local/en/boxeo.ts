...
export default {
  ...
  mc_bx_q_disc: 'What are you training?',
  mc_bx_disc_boxing: 'Boxing',
  mc_bx_disc_kick: 'Kickboxing',
  mc_bx_disc_muay: 'Muay Thai',
  mc_bx_disc_mma: 'MMA',
  mc_bx_q_gear: 'What gear do you have?',
  mc_bx_gear_ph: 'Jump rope, 10 kg dumbbells, bands…',
  mc_bx_gear_rope: 'jump rope',
  mc_bx_gear_dumbbells: 'dumbbells',
  mc_bx_gear_bands: 'bands',
