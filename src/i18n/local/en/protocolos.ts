...
export default {
  ...
  mc_pt_empty_desc: 'Create one with its segments, or paste the table your coach gave you and we turn it into a script you can follow while training.',
  mc_pt_play: 'Start',
...
10-15 incl 3   speed 6.5`,
  ...
  mc_rp_empty_desc: 'Create one with your days and exercises, or paste the routine you already have and we turn it into a checklist you can tick off.',
