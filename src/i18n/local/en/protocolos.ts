...
Barbell row 4x10`,
  ...
  mc_pt_free: 'Free',
  mc_pt_free_hint: 'Go at your own pace: tap “Done” when you finish.',
  mc_pt_rv_details: 'Details (optional)',
  mc_pt_rv_minutes: 'Minutes',
  mc_pt_rv_note: 'Notes',
  mc_pt_rv_note_ph: 'How it went, what you would change…',
  mc_pt_rv_need_min: 'Enter the minutes you did to save it.',
  mc_pt_rv_back: 'Back to the session',
  mc_ag_go_title: 'How do you want to do it?',
  mc_ag_go_start: 'Start now',
  mc_ag_go_start_hint: 'With a stopwatch and the plan note in view. When you finish, save it with your pace, distance or notes.',
  mc_ag_go_start_plain: 'Start without rounds, just a stopwatch',
  mc_cs_to_timer: 'Open in the timer',
  mc_cs_do_table: 'Follow the table',
  mc_cs_saved_boxing: 'Saved to Coach › Session',
