...
export default {
  ...
  mc_pt_done_title: 'Session complete!',
...
Barbell row 4x10`,
  ...
  mc_pt_prev: 'Previous',
  mc_pt_of_total: 'of {{time}}',
  mc_pt_elapsed: '{{time}} elapsed',
  mc_pt_reps: 'reps',
  mc_pt_reps_manual: 'Do the reps at your own pace and tap “Done” when you finish.',
  mc_pt_rest_title: 'Breathe',
  mc_pt_rest_eyebrow: 'Rest',
  mc_pt_get_ready: 'Get ready',
  mc_pt_whole: 'Full session',
  mc_pt_tap_to_jump: 'Tap a segment to jump to it',
  mc_pt_col_time: 'Time',
  mc_pt_keys_hint: 'Space: pause · ← →: change segment',
  mc_cs_default_name: 'Coach session',
  mc_cs_rest: 'Rest',
  mc_cs_segments_one: '{{count}} segment',
  mc_cs_segments_other: '{{count}} segments',
  mc_cs_do: 'Do this session',
  mc_cs_save: 'Save',
  mc_cs_saved: 'Saved',
  mc_cs_saved_toast: 'Saved to Activity › Saved cardio',
  mc_cs_saved_local: 'Saved on this device: find it in Activity › Saved cardio',
};
