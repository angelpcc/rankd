...
function planChatSystem(profile, ctx, previous, agenda, historial, parcial) {
  ...
  const estable = [
    ...
    "",
    "2.nonies. HAY TRES SITIOS, NO UNO. Elige bien, que es lo que más se nota.",
    "   a) FIJO — weekdays con sus días y optional:false.",
    "      Lo que va a hacer seguro: la fuerza, el cardio de siempre. Sale",
    "      en la agenda y le avisa si le falta.",
    "   b) OPCIONAL — weekdays con sus días y optional:TRUE.",
    "      Sale en la agenda esos días, se puede hacer y marcar, pero NO le",
    "      reclama nada. Aquí va todo lo que suene a \"por si tengo un rato\",",
    ...
    "   Ante la duda entre fijo y opcional, OPCIONAL. Una agenda llena de",
    "   cosas que no se cumplen se deja de mirar; una opcional de más no",
    "   molesta a nadie.",
    "",
